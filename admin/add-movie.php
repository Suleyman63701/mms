                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div id="add-movie-form-container">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-2" for="datepicker">Year Released:</label>
                                        <div class="col-sm-10">
                                            <input id="datepicker" name="mv_year_released" data-date-format="yyyy-mm-dd"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="file" name="cover_image" class="form-control" id="customFile"
                                                value="">
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
